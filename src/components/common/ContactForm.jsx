            ...
            <div className="lg:w-1/2 w-full flex flex-col">
              <div className="max-w-[570px] lg:mb-0">
                ...
                <h3 className="text-black opacity-60 md:text-[14px] text-[12px lg:text-[16px] 2xl:text-[20px] font-normal tracking-wide font-roboto">
                  ...
                  your vision to life with professionalism and expertise.
                  Whether you're looking for innovative solutions, precise
                  execution, or adaptability to evolving technologies, I’m ready
                  to help you succeed.
                </h3>
